...
#
# Optional databag merge for attributes
#
default['boundary_meter']['data_bag']['merge'] = false
default['boundary_meter']['data_bag']['name']= ''
default['boundary_meter']['data_bag']['item'] = ''

#
# Optional meter.conf config hash for
#
default['boundary_meter']['meter_conf'] = {}
